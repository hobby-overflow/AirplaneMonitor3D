...
declare namespace THREE {
    ...
    class ColladaLoader {
        ...
        load(url: string, onLoad?: (object: ColladaObject) => void, onProgress?: (progress: ColladaLoadProgress) => void, onFail?: (reason: ColladaLoadError) => void): void;
        parse(doc: XMLDocument, callback?: (object: ColladaObject) => void, url?: string): void;
        setPreferredShading(shading: THREE.Shading): void;
        applySkin(geometry: THREE.Geometry, instanceCtrl: any, frame?: number): void;
    }
}